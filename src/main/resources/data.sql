...
values
    (1, 'test_schema1', 'seol', null, now(), 'seol', now(), 'seol')
;
...
values
    (1, 1, 'id', 'ROW_NUMBER', '{"start": 1, "step": 1}', 0, null, now(), 'seol', now(), 'seol'),
    (1, 3, 'age', 'NUMBER', '{"min": 10, "max": 30, "decimals": 0}', 50, null, now(), 'seol', now(), 'seol'),
    (1, 2, 'name', 'STRING', '{"minLength": 1, "maxLength": 10}', 0, null, now(), 'seol', now(), 'seol'),
    (1, 4, 'active', 'BOOLEAN', null, 0, 'true', now(), 'seol', now(), 'seol')
;
